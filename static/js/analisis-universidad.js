...
/*function calcularEstadisticas() {
    const tablaDatos = document.getElementById('tablaClasifUniversidad');
...
const filas = document.querySelectorAll("#tablaAscensoUniversidad tbody tr");
...
const tabla = document.querySelector("#tablaAscensoUniversidad tbody");
...
const filas1 = document.querySelectorAll("#tablaPlayUniversidad tbody tr");
...
const tabla1 = document.querySelector("#tablaPlayUniversidad tbody");
...
const filas2 = document.querySelectorAll("#tablaDescUniversidad tbody tr");
...
const tabla2 = document.querySelector("#tablaDescUniversidad tbody");
